...
COMMENT ON COLUMN UTIL.CUR_EXCH_RATE_HISTORY.ID IS 'Унікальний ідентифікатор.Ненулевий стовпець';
COMMENT ON COLUMN UTIL.CUR_EXCH_RATE_HISTORY.CURR_ID IS 'Ідентифікатор курсу валют.Ненулевий стовпець.';
COMMENT ON COLUMN UTIL.CUR_EXCH_RATE_HISTORY.CURR_TEXT IS 'Tекстовий формат курсу валют.Ненулевий стовпець.';
COMMENT ON COLUMN UTIL.CUR_EXCH_RATE_HISTORY.RATE IS 'Курс валют.Ненулевий стовпець.';
COMMENT ON COLUMN UTIL.CUR_EXCH_RATE_HISTORY.CURR_CODE IS 'Код курсу валют.Ненулевий стовпець.';
